...
hanoi4-legacy-1991-imbs-weak-pos
...
run_report() {
  ...
  case "$report_name" in
    ...
    hanoi4-historical)
      ...
      ;;
    hanoi4-solve-candidates)
      sh "$SCRIPT_DIR/compare-hanoi4-solve-candidates-sbcl.sh"
      ;;
    hanoi4-score-sensitivity)
...
run_trace() {
  ...
  case "$trace_name" in
    ...
    hanoi4-legacy-1991-isbm-weak-pos)
      ...
      ;;
    hanoi4-legacy-1991-imbs-weak-pos)
      HIERARCHY=legacy-1991-imbs sh "$SCRIPT_DIR/trace-hanoi4-weak-pos-sbcl.sh"
      ;;
    hanoi4-ismb-weak-pos)
    ...
    hanoi4-imbs-h1-weak-pos)
      ...
      ;;
    hanoi4-imbs-hb-weak-pos)
      HIERARCHY=imbs-hb sh "$SCRIPT_DIR/trace-hanoi4-weak-pos-sbcl.sh"
      ;;
    hanoi4-recursive-clearance-weak-pos)
      HIERARCHY=recursive-clearance sh "$SCRIPT_DIR/trace-hanoi4-weak-pos-sbcl.sh"
      ;;
    hanoi4-isbm-weak-pos)
      HIERARCHY=isbm sh "$SCRIPT_DIR/trace-hanoi4-weak-pos-sbcl.sh"
      ;;
    hanoi4-isbm-hb-weak-pos)
      HIERARCHY=isbm-hb sh "$SCRIPT_DIR/trace-hanoi4-weak-pos-sbcl.sh"
      ;;
    hanoi4-isbm-h1-weak-pos)
