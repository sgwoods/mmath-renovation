...
print_row "simple-robot-1" "tweak" "robot1-tweak" "user-defined heuristic plus primary effects"
print_row "simple-robot-1" "abtweak" "robot1-abtweak" "solves with left-wedge enabled"
print_row "simple-robot-1" "abtweak, no left-wedge" "robot1-abtweak-no-lw" "same bounds, left-wedge disabled"
