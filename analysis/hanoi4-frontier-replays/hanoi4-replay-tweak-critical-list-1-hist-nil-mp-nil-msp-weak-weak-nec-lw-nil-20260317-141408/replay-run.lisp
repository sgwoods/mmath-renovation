...
(let* ((run-dir "/Users/stevenwoods/mmath-renovation/analysis/hanoi4-frontier-replays/hanoi4-replay-tweak-critical-list-1-hist-nil-mp-nil-msp-weak-weak-nec-lw-nil-20260317-141408/")
       ...
       (priority-records
        (frontier-replay-cohort
         nodes 'priority 3 #'frontier-sort-by-priority
         :planner-mode 'tweak
         :mp-mode nil
         :mp-weak-mode 'nec
         :abstract-goal-mode nil
         ...
         :solution-limit 100
         :expand-bound 3000
         :generate-bound 15000
         :open-bound 15000
         :cpu-sec-limit 30))
       (closure-records
        (frontier-replay-cohort
         nodes 'closure 3 #'frontier-sort-by-unsat-count
         :planner-mode 'tweak
         :mp-mode nil
         :mp-weak-mode 'nec
         :abstract-goal-mode nil
