...
(let* ((run-dir "/Users/stevenwoods/mmath-renovation/analysis/hanoi4-frontier-replays/hanoi4-replay-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-lw-t-20260317-141256/")
       ...
       (priority-records
        (frontier-replay-cohort
         nodes 'priority 2 #'frontier-sort-by-priority
         :planner-mode 'abtweak
         :mp-mode t
         :mp-weak-mode 'pos
         :abstract-goal-mode t
       ...
       (closure-records
        (frontier-replay-cohort
         nodes 'closure 2 #'frontier-sort-by-unsat-count
         :planner-mode 'abtweak
         :mp-mode t
         :mp-weak-mode 'pos
         :abstract-goal-mode t
  ...
  (format t "SOURCE-SOLUTION: ~S~%" *solution*)
