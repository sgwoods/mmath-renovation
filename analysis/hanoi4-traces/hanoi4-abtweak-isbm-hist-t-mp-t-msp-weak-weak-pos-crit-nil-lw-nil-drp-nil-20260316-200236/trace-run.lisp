...
(let* ((trace-dir "/Users/stevenwoods/mmath-renovation/analysis/hanoi4-traces/hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-nil-drp-nil-20260316-200236/")
  ...
  (with-open-file (stream summary-log
    ...
    (format stream "Case: hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-nil-drp-nil-20260316-200236~%")
    ...
    (format stream "Generate bound: ~S~%" 400000)
    (format stream "Open bound: ~S~%" 400000)
