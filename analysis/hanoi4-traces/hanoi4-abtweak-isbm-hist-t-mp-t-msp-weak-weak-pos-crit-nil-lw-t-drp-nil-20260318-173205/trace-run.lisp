...
(let* ((trace-dir "/Users/stevenwoods/mmath-renovation/analysis/hanoi4-traces/hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-t-drp-nil-20260318-173205/")
  ...
  (with-open-file (stream summary-log
    ...
    (format stream "Case: hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-t-drp-nil-20260318-173205~%")
    ...
    (format stream "Expand bound: ~S~%" 10000)
    (format stream "Generate bound: ~S~%" 40000)
    (format stream "Open bound: ~S~%" 40000)
