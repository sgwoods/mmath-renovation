...
(let* ((trace-dir "/Users/stevenwoods/mmath-renovation/analysis/hanoi4-traces/hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-t-drp-nil-20260317-094513/")
  ...
  (with-open-file (stream summary-log
    ...
    (format stream "Case: hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-t-drp-nil-20260317-094513~%")
    ...
    (format stream "Expand bound: ~S~%" 150000)
    (format stream "Generate bound: ~S~%" 600000)
    (format stream "Open bound: ~S~%" 600000)
    (format stream "CPU limit: ~S~%" 90)
    (format stream "~%")
