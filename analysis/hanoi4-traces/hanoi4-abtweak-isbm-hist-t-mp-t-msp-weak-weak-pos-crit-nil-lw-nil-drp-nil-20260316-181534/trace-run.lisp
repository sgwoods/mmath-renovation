...
(let* ((trace-dir "/Users/stevenwoods/mmath-renovation/analysis/hanoi4-traces/hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-nil-drp-nil-20260316-181534/")
  ...
  (with-open-file (stream summary-log
    ...
    (format stream "Case: hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-nil-drp-nil-20260316-181534~%")
    ...
    (format stream "Expand bound: ~S~%" 1000)
    (format stream "Generate bound: ~S~%" 4000)
    (format stream "Open bound: ~S~%" 4000)
    (format stream "CPU limit: ~S~%" 10)
    (format stream "~%")
