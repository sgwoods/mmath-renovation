...
(let* ((trace-dir "/Users/stevenwoods/mmath-renovation/analysis/hanoi4-traces/hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-t-drp-nil-20260321-155348/")
  ...
  (with-open-file (stream summary-log
    ...
    (format stream "Case: hanoi4-abtweak-isbm-hist-t-mp-t-msp-weak-weak-pos-crit-nil-lw-t-drp-nil-20260321-155348~%")
    ...
    (format stream "Generate bound: ~S~%" 900000)
    (format stream "Open bound: ~S~%" 900000)
    (format stream "CPU limit: ~S~%" 180)
    (format stream "~%")
