...
(let* ((trace-dir "/Users/stevenwoods/mmath-renovation/analysis/hanoi4-traces/hanoi4-ismb-mp-t-lw-t-drp-nil-20260315-160720/")
  ...
  (with-open-file (stream summary-log
    ...
    (format stream "Case: hanoi4-ismb-mp-t-lw-t-drp-nil-20260315-160720~%")
    ...
    (format stream "CPU limit: ~S~%" 40)
    (format stream "~%")
    (write-trace-summary stream))
  (write-open-frontier-snapshot open-log :limit 50)
