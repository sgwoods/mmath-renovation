...
(defvar *motive-discard*   nil  "one of : nil- use all ops, t- use discard opt")
...
(defun planner (initial goal &key 
  ...
  (declare 
        ...
        (type boolean motive-discard)        ; id code, default = d
  ...
  (setq *motive-discard*  motive-discard)
...
(defun gen-stats ()
    ...
    (princ "motive-discard : ")   (princ *motive-discard*)     (terpri)
