; From qyang@logos.uwaterloo.ca Tue Nov 12 05:58:45 1991
; 
; Steve, 
; things are fine here, a little cold though.  I will be talking to Josh again
; soon, so I'll let you know what happened.  The data you gave me looks 
; good.  How did you plot it?  Also, the correlation part, is it correlation
; of Time vs. Expanded, or MP pruned vs. expaned, or MP pruned vs. time?  It
; is not entirely clear from what you gave me.
; 
; Below I give you the code for ab-successors.lsp.  Put it in Ab-routines
; Actually, if you would like to see Josh's changes, you can get an idea from
; the algorithm.tex that I have sent you.
; 
; Take care,  I'll get back to you soon.
; 
; Qiang
; 
