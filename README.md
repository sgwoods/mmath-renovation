...
- [Hanoi-4 1991 compatibility start](./docs/hanoi4-1991-compatibility.md): current four-disk historical-control surface, including restored `strong` MSP and the current tree-goal-ordering gap
