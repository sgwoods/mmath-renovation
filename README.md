...
- [Hanoi-4 hierarchy experiment plan](./docs/hanoi4-hierarchy-experiment-plan.md): disciplined next-step plan for testing alternative four-disk hierarchy descriptions while keeping historically grounded analogue work separate from later named strategy extensions
